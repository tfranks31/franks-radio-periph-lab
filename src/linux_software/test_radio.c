...
void print_benchmark(volatile unsigned int *periph_base)
{
    ...
    // It's possible that the timer register overflowed while measuring.
    // If the start time is greater than the stop time, we know that it overflowed.
    ...
    throughput = bytes_transferred / time_spent / 1000000.0;
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 7 Tyler Franks - Custom Peripheral Demonstration\n\r");
